...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine z_uprk_compress2_slow(QZ,VECR,VECL,ID,N,K,Ain,Bin,P,Q,D1,&
...
end subroutine z_uprk_compress2_slow
