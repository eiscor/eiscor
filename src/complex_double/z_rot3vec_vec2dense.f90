...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine z_rot3vec_vec2dense(ID,BSIZE,NBLKS,Q,M,Z,WORK)

  implicit none

  ! input variables
  logical, intent(in) :: ID
  integer, intent(in) :: BSIZE, NBLKS, M
  real(8), intent(in) :: Q(3*BSIZE*BSIZE*NBLKS)
  complex(8), intent(inout) :: Z(M,2*BSIZE*NBLKS), WORK(BSIZE,BSIZE)
...
end subroutine z_rot3vec_vec2dense
