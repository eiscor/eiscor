...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine z_uprkdense_qz2(VECR,VECL,N,K,A,B,M,EIGSA,EIGSB,V,W,S,T,INFO)
...
!!$  end if  
  ...
  call z_uprk_compress2(.TRUE.,VECR,VECL,.TRUE.,N,K,A,B,P,Q,&
  ...
  !print*, "end z_uprkdense_qz2",N, K
  
end subroutine z_uprkdense_qz2
