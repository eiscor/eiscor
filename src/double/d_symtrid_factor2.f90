...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine d_symtrid_factor2(VEC,ID,SCA,N,D,E,Q,QD,SCALE,M,Z,INFO)
...
!!$               
!!$     ! fusion at top
!!$     call z_unifact_mergebulge(.TRUE.,Q(1:3),QD(1:2),bulge)
!!$
!!$  end do

end subroutine d_symtrid_factor2
