...
program test_z_rot3_turnover
  ...
  histot(1,:) = (/           0,           0,           0,           0,           0,      116000,      120000,       25000/)!
  histot(2,:) = (/           0,           0,           0,           0,           0,           0,           0,           0/)!
  histot(3,:) = (/       15500,       27500,       39000,       59980,       36000,        4000,           0,       44000/)!
  histot(4,:) = (/      103000,       90000,       80000,       60000,       80000,           0,           0,       50000/)!
  histot(5,:) = (/        1500,        2500,        1000,          20,        4000,           0,           0,        1000/)!
