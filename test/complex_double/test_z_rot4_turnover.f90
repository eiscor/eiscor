...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! test_z_rot4_turnover
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! This program tests the subroutine z_rot4_turnover (turnover). The following 
! tests are run:
!
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
program test_z_rot4_turnover
  
  implicit none
  
  ! parameter
  !integer, parameter :: nt = 2 ! number of testcases
  ...
  real(8) :: Q1(4), Q2(4), Q3(3)
  real(8) :: time
  real(8) :: rp, rm, rn, nrm, pi = 3.141592653589793239d0
  ...
  do ii=1,nt
     ...
     call z_rot4_accum_to_err(Q1,Q2,Q3,accum,tol,histo,pass_cur)
  end do
...
!!$  end if
  ...
  histot(3,:) = (/           0,       27500,       39000,       59980,       36000,        3960,           0,       44000/)!
  histot(4,:) = (/      115000,       90000,       80000,       60000,       80000,          40,           0,       50000/)!
  histot(5,:) = (/        5000,        2500,        1000,          20,        4000,           0,           0,        2000/)!
...
end program test_z_rot4_turnover

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! subroutine z_rot4_accum_to_err
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! z_rot4_accum_to_err computes the 3x3  matrix Hs 
...
! INPUT VARIABLES
!
!  Q1, Q2, Q3      REAL(8) arrays of dimension (4,4,3)
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine z_rot4_accum_to_err(Q1,Q2,Q3,accum,tol,histo,pass_cur)

  implicit none

  real(8), intent(inout) :: Q1(4), Q2(4), Q3(3)
...
!!$  print*, "Q3", Q3
  ...
  A1(2,1)=cmplx(Q1(3),Q1(4),kind=8)
  A1(1,2)=cmplx(-Q1(3),Q1(4),kind=8)
  A1(2,2)=cmplx(Q1(1),-Q1(2),kind=8)
  A1(3,3)=cmplx(1d0,0d0,kind=8)
  !
  A2(1,1)=cmplx(1d0,0d0,kind=8)
  A2(2,2)=cmplx(Q2(1),Q2(2),kind=8)
  A2(3,2)=cmplx(Q2(3),Q2(4),kind=8)
  A2(2,3)=cmplx(-Q2(3),Q2(4),kind=8)
  ...
  do jj=2,accum
     ...
     if (mod(jj,2) == 0) then
        !print*, "backward"
        ! backward turnover (Q3 on the left at begin)
        Q1(2) = -Q1(2)
        Q1(3) = -Q1(3)
        Q1(4) = -Q1(4)
        ...
        !print*, "forward"
        ! forward turnover (Q3 on the right at begin)
        call z_rot4_turnover(Q1,Q2,Q3)
     end if
...
end subroutine z_rot4_accum_to_err
