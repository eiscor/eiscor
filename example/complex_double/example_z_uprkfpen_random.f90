...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
program example_z_uprkfpen_random
  ...
  call z_uprkdense_qz(.FALSE.,N,K,MA,MB,N,EIGSA,EIGSB,V,W,TA,TB,INFO)
  ...
  call z_uprkdense_qz_slow(.TRUE.,N,k,MA,MB,N,EIGSA,EIGSB,V,W,TA,TB,INFO)
...
end program example_z_uprkfpen_random
