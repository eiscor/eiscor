...
program example_z_uprkfpen_6random
  ...
  ! print banner
  print*,""
  print*,"example_z_uprkfact_6randompencil:"
  ...
  do qq=1,2
     ...
     if (qq.EQ.2) then
        ...
        !MB(N,k)=cmplx(0d0,0d0,kind=8)
        !MB(N-1,k-1)=cmplx(0d0,0d0,kind=8)
        !MB(N-2,k-2)=cmplx(0d0,0d0,kind=8)
        MA(k,k)=cmplx(0d0,0d0,kind=8)
        !MA(5,5)=cmplx(0d0,0d0,kind=8)
        !MA(6,6)=cmplx(0d0,0d0,kind=8)
        !MA(7,7)=cmplx(0d0,0d0,kind=8)
        !MA(8,8)=cmplx(0d0,0d0,kind=8)
