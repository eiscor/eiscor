...
program example_z_poly_roots
  ...
  do kk = 1,48 
     ...
     case (2) ! Wilkinson Polynomial !check
        ...
        eigsknown = .TRUE.
        EROOTS(1)  = cmplx(1d0,0d0)
        EROOTS(2)  = cmplx(2d0,0d0)
        EROOTS(3)  = cmplx(3d0,0d0)
        EROOTS(4)  = cmplx(4d0,0d0)
        EROOTS(5)  = cmplx(5d0,0d0)
        EROOTS(6)  = cmplx(6d0,0d0)
        EROOTS(7)  = cmplx(7d0,0d0)
        EROOTS(8)  = cmplx(8d0,0d0)
        EROOTS(9)  = cmplx(9d0,0d0)
        EROOTS(10) = cmplx(10d0,0d0)
        EROOTS(11) = cmplx(11d0,0d0)
        EROOTS(12) = cmplx(12d0,0d0)
        EROOTS(13) = cmplx(13d0,0d0)
        EROOTS(14) = cmplx(14d0,0d0)
        EROOTS(15) = cmplx(15d0,0d0)
        COEFFS(  1) = cmplx( 1.000000000000000000D+00, 0.000000000000000000D+00,kind=8)
     ...
     case (3) ! Wilkinson Polynomial
        ...
        EROOTS(14) = cmplx(14d0,0d0)
        EROOTS(15) = cmplx(15d0,0d0)
        EROOTS(16) = cmplx(16d0,0d0)
        EROOTS(17) = cmplx(17d0,0d0)
        EROOTS(18) = cmplx(18d0,0d0)
        EROOTS(19) = cmplx(19d0,0d0)
        EROOTS(20) = cmplx(20d0,0d0)
        COEFFS(  1) = cmplx( 1.000000000000000000D+00, 0.000000000000000000D+00,kind=8)
     ...
     case (4)  ! monic polynomial roots [-2.1:0.2:1.7]
        ...
        eigsknown = .TRUE.           
        EROOTS(1)  = cmplx(-2.1d0,0d0)
        EROOTS(2)  = cmplx(-1.9d0,0d0)
        EROOTS(3)  = cmplx(-1.7d0,0d0)
        EROOTS(4)  = cmplx(-1.5d0,0d0)
        EROOTS(5)  = cmplx(-1.3d0,0d0)
        EROOTS(6)  = cmplx(-1.1d0,0d0)
        EROOTS(7)  = cmplx(-0.9d0,0d0)
        EROOTS(8)  = cmplx(-0.7d0,0d0)
        EROOTS(9)  = cmplx(-0.5d0,0d0)
        EROOTS(10) = cmplx(-0.3d0,0d0)
        EROOTS(11) = cmplx(-0.1d0,0d0)
        EROOTS(12) = cmplx(0.1d0,0d0)
        EROOTS(13) = cmplx(0.3d0,0d0)
        EROOTS(14) = cmplx(0.5d0,0d0)
        EROOTS(15) = cmplx(0.7d0,0d0)
        EROOTS(16) = cmplx(0.9d0,0d0)
        EROOTS(17) = cmplx(1.1d0,0d0)
        EROOTS(18) = cmplx(1.3d0,0d0)
        EROOTS(19) = cmplx(1.5d0,0d0)
        EROOTS(20) = cmplx(1.7d0,0d0)
     ...
     case (7)  ! inverse Wilkinson polynomial degree 20
        ...
        case (8)  ! univariate polynomial with zeros 2^-10, 2^-9, ..., 2^8, 2^9
           ...
           eigsknown = .TRUE.
           EROOTS(1)  = cmplx(1d0/1024d0,0d0)
           EROOTS(2)  = cmplx(1d0/512d0,0d0)
           EROOTS(3)  = cmplx(1d0/256d0,0d0)
           EROOTS(4)  = cmplx(1d0/128d0,0d0)
           EROOTS(5)  = cmplx(1d0/64d0,0d0)
           EROOTS(6)  = cmplx(1d0/32d0,0d0)
           EROOTS(7)  = cmplx(0.0625d0,0d0)
           EROOTS(8)  = cmplx(0.125d0,0d0)
           EROOTS(9)  = cmplx(0.25d0,0d0)
           EROOTS(10) = cmplx(0.5d0,0d0)
           EROOTS(11) = cmplx(1d0,0d0)
           EROOTS(12) = cmplx(2d0,0d0)
           EROOTS(13) = cmplx(4d0,0d0)
           EROOTS(14) = cmplx(8d0,0d0)
           EROOTS(15) = cmplx(16d0,0d0)
           EROOTS(16) = cmplx(32d0,0d0)
           EROOTS(17) = cmplx(64d0,0d0)
           EROOTS(18) = cmplx(128d0,0d0)
           EROOTS(19) = cmplx(256d0,0d0)
           EROOTS(20) = cmplx(512d0,0d0)
        ...
        case (9)  ! univariate polynomial with zeros 2^-10, 2^-9, ..., 2^8, 2^9
           print*, "univariate polynomial with zeros 2^-10, 2^-9, ..., 2^8, 2^9"
           eigsknown = .TRUE.
           EROOTS(1)  = cmplx(1d0/1024d0-3d0,0d0)
           EROOTS(2)  = cmplx(1d0/512d0-3d0,0d0)
           EROOTS(3)  = cmplx(1d0/256d0-3d0,0d0)
           EROOTS(4)  = cmplx(1d0/128d0-3d0,0d0)
           EROOTS(5)  = cmplx(1d0/64d0-3d0,0d0)
           EROOTS(6)  = cmplx(1d0/32d0-3d0,0d0)
           EROOTS(7)  = cmplx(0.0625d0-3d0,0d0)
           EROOTS(8)  = cmplx(0.125d0-3d0,0d0)
           EROOTS(9)  = cmplx(0.25d0-3d0,0d0)
           EROOTS(10) = cmplx(0.5d0-3d0,0d0)
           EROOTS(11) = cmplx(1d0-3d0,0d0)
           EROOTS(12) = cmplx(2d0-3d0,0d0)
           EROOTS(13) = cmplx(4d0-3d0,0d0)
           EROOTS(14) = cmplx(8d0-3d0,0d0)
           EROOTS(15) = cmplx(16d0-3d0,0d0)
           EROOTS(16) = cmplx(32d0-3d0,0d0)
           EROOTS(17) = cmplx(64d0-3d0,0d0)
           EROOTS(18) = cmplx(128d0-3d0,0d0)
           EROOTS(19) = cmplx(256d0-3d0,0d0)
           EROOTS(20) = cmplx(512d0-3d0,0d0)
        ...
        case (13) ! Mandelbort 31 MPSolve
           ...
           eigsknown = .TRUE.          
           EROOTS( 1 ) = cmplx(-1.996376137,0d0)
           EROOTS( 2 ) = cmplx(-1.966773216,0d0)
           EROOTS( 3 ) = cmplx(-1.907280091,0d0)
           EROOTS( 4 ) = cmplx(-1.772892903,0d0)
           EROOTS( 5 ) = cmplx(-1.754877666,0d0)
           EROOTS( 6 ) = cmplx(-1.47601464272,0d0)
           EROOTS( 7 ) = cmplx(-1.284084925525, 4.272688960406d-1)
           EROOTS( 8 ) = cmplx(-1.284084925525,-4.272688960406d-1)
           EROOTS( 9 ) = cmplx(-1.138000666650,-2.403324012620d-1)
           EROOTS( 10 )= cmplx(-1.138000666650, 2.403324012620d-1)
           EROOTS( 11 )= cmplx(-1d0,0d0)
           EROOTS( 12 )= cmplx(-5.968916446451269d-1, 6.629807445770295d-1)
           EROOTS( 13 )= cmplx(-5.968916446451269d-1,-6.629807445770295d-1)
           EROOTS( 14 )= cmplx(-2.17526747030511d-1,-1.11445426587329)
           EROOTS( 15 )= cmplx(-2.17526747030511d-1, 1.11445426587329)
           EROOTS( 16 )= cmplx(-1.6359826155202d-1, 1.09778064288827)
           EROOTS( 17 )= cmplx(-1.6359826155202d-1,-1.09778064288827)
           EROOTS( 18 )= cmplx(-1.225611668766536d-1,-7.4486176661974423d-1)
           EROOTS( 19 )= cmplx(-1.225611668766536d-1, 7.4486176661974423d-1)
           EROOTS( 20 )= cmplx(-1.13418655949436d-1,-8.605694725015730d-1)
           EROOTS( 21 )= cmplx(-1.13418655949436d-1,8.605694725015730d-1)
           EROOTS( 22 )= cmplx(-1.5570386020902d-2, 1.020497366498289d0)
           EROOTS( 23 )= cmplx(-1.5570386020902d-2,-1.020497366498289d0)
           EROOTS( 24 )= cmplx(3.59892739012579001d-1, 6.84762020211812856d-1)
           EROOTS( 25 )= cmplx(3.59892739012579001d-1,-6.84762020211812856d-1)
           EROOTS( 26 )= cmplx(3.8900684056977123543d-1,-2.1585065087081910777d-1)
           EROOTS( 27 )= cmplx(3.8900684056977123543d-1, 2.1585065087081910777d-1)
           EROOTS( 28 )= cmplx(3.96534570032415023d-1, 6.04181810488988837d-1)
           EROOTS( 29 )= cmplx(3.96534570032415023d-1,-6.04181810488988837d-1)
           EROOTS( 30 )= cmplx(4.433256333996235387d-1, 3.729624166628465083d-1)
           EROOTS( 31 )= cmplx(4.433256333996235387d-1,-3.729624166628465083d-1)
      ...
      case (14) ! Mandelbort 63 MPSolve
           ...
           eigsknown = .TRUE.
           EROOTS( 1 )=cmplx(-1.999095682327018473210d0,0d0)
           EROOTS( 2 )=cmplx(-1.9918141725491222157325609498622881d0,0d0)
           EROOTS( 3 )=cmplx(-1.977179587006257387346088520662828616836d0,0d0)
           EROOTS( 4 )=cmplx(-1.953705894284396245427622199013653238901d0,0d0)
           EROOTS( 5 )=cmplx(-1.927147709363950262460068188946594278007d0,0d0)
           EROOTS( 6 )=cmplx(-1.8848035715866817923294780929158396496359d0,0d0)
           EROOTS( 7 )=cmplx(-1.8323152027512291920848975260425181432293d0,0d0)
           EROOTS( 8 )=cmplx(-1.76926167027683114607548022863625740038777d0, 5.6919500395600315304900187298015859319654d-2)
           EROOTS( 9 )=cmplx(-1.76926167027683114607548022863625740038777d0,-5.6919500395600315304900187298015859319654d-2)
           EROOTS( 10 )=cmplx(-1.674066091474787971565296029172325596206403d0,0d0)
           EROOTS( 11 )=cmplx(-1.5748891397523009698199655524959742837719482d0,0d0)
